...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, SmsSendMessageDto> producerSmsSendFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    public KafkaTemplate<String, SmsSendMessageDto> kafkaTemplate() {
        KafkaTemplate<String, SmsSendMessageDto> template = new KafkaTemplate<>(producerSmsSendFactory());
